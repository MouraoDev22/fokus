...
const mscPlay = new Audio("./assets/sons/play.wav");
const mscPause = new Audio("./assets/sons/pause.mp3");
const mscBeep = new Audio("./assets/sons/beep.mp3");
let timerID = null;
let focusTime = 1500;
...
function reset() {
    ...
    const shortBreakActive = html.getAttribute("data-contexto") === "descanso-curto";
    const longBreakActive = html.getAttribute("data-contexto") === "descanso-longo";
    startPauseButtonSpan.textContent = "Começar";
    startPauseButtonImg.setAttribute("src", "./assets/imagens/play_arrow.png");
    if (focusActive) {
